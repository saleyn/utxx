/**
 * This module implements a concurrent lock-free stack.
 * Note: this implementation has an ABA problem.
 */
/*-----------------------------------------------------------------------------
 ...
 * $Id$
 */
#ifndef _UTIL_CONCURRENT_STACK_HPP_
#define _UTIL_CONCURRENT_STACK_HPP_
...
#endif  // _UTIL_CONCURRENT_STACK_HPP_
