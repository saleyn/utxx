/**
 * This module implements a robust mutex that can be shared between processes.
 */
/*-----------------------------------------------------------------------------
 * Copyright (c) 2012 Serge Aleynikov <serge@aleynikov.org>
 *
...
#ifndef _UTIL_ROBUST_MUTEX_HPP_
#define _UTIL_ROBUST_MUTEX_HPP_
