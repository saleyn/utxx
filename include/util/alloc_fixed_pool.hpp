/**
 * This module implements a concurrent lock-free fixed size pool manager
 * for objects allocated in the heap or shared memory.
 *
...
#ifndef _UTIL_ALLOC_FIXED_POOL_HPP_
#define _UTIL_ALLOC_FIXED_POOL_HPP_
