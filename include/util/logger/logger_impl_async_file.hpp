/**
 * Front-end plugin implementing asynchronous writer for the <logger>
 * class. This logger is optimized for imposing minimal overhead on the
 ...
 * $Id$
 */
#ifndef _UTIL_LOGGER_ASYNC_FILE_HPP_
#define _UTIL_LOGGER_ASYNC_FILE_HPP_
...
#endif // _UTIL_LOGGER_ASYNC_FILE_HPP_
