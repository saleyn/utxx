/**
 * Logging class that implements light-weight logging of messages to configured 
 * targets.  The client supports pluggable back-ends that can write messages
 ...
 * $Id$
 */
#ifndef _UTIL_MAIN_LOGGER_HPP_
#define _UTIL_MAIN_LOGGER_HPP_
...
#include <util/logger/logger_impl.ipp> // Logger implementation

#endif  // _UTIL_MAIN_LOGGER_HPP_
