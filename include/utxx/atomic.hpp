...
static inline long add(volatile long* v, long inc)
{
    long ret;
    __asm__ __volatile__ (
        "lock xadd" UTXX_QorL_SUFFIX " %0,(%1)"
        : "=r" (ret)
        : "r" (v), "0" (inc)
        : "memory"
    );
...
{
    __asm__ __volatile__("lock; inc" UTXX_QorL_SUFFIX " %0" : "=m" (*c) : "m" (*c));
}

static inline void dec(volatile long* c)
{
    __asm__ __volatile__("lock; dec" UTXX_QorL_SUFFIX " %0" : "=m" (*c) : "m" (*c));
}
...
static inline long xchg(volatile long* target, long value)
{
    long ret;
    __asm__ __volatile__ (
          "lock xchg" UTXX_QorL_SUFFIX " %2,(%1)"
        : "=r" (ret)
        : "r" (target), "0" (value)
        : "memory"
    );
...
{
    unsigned long r;
    __asm__ __volatile__( "bsf" UTXX_QorL_SUFFIX " %1, %0": "=r"(r): "rm"(v) );
    return r;
}
...
{
    unsigned long r;
    __asm__ __volatile__( "bsr" UTXX_QorL_SUFFIX " %1, %0": "=r"(r): "rm"(v) );
    return r;
}
*/
