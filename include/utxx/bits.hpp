...
#   define UTXX_ADDR(x) "=m" (*(volatile long *) (x))
#else
#   define UTXX_ADDR(x) "+m" (*(volatile long *) (x))
#endif
#define UTXX_CONST_MASK_ADDR(n, addr) UTXX_ADDR((char*)(addr) + ((n)>>3))
